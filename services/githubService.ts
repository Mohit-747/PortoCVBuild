...
import { PortfolioData, ProgressCallback } from "../types";

export const deployToGitHub = async (rawToken: string, data: PortfolioData, onProgress?: ProgressCallback): Promise<string> => {
  ...
  log?.("Generating index.html artifact...");
...
<body>
  ...
  log?.("HTML uploaded successfully.");
  ...
  log?.("Deployment trigger successful.");
